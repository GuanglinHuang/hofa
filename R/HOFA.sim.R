#' Genereate panel data from [H]igher-[O]rder multi-cumulant [F]actor [M]odel (HOFA)
#'
...
#' @param sig_e The minimum and maximum variance of error terms
...
#' rho_ar = c(0.5,0.2);
#' HOFA.sim(n,t,k,par_f,par_e,rho_ar)

HOFA.sim = function(n,t,k,par_f,par_e,rho_ar,sig_e = c(0.5,5),...){
